...
#
atlas.graph.storage.backend=cassandrathrift
atlas.graph.storage.hostname=cassandra
atlas.graph.storage.clustername=Test Cluster
...
atlas.kafka.zookeeper.connect=zookeeper-1:2181
atlas.kafka.bootstrap.servers=broker-1:9092,broker-2:9093
